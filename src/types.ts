...
export interface F1FlightInfo{departureAirport?:'TFU'|'CTU';routeType?:'domestic'|'international';departureDate?:string;departureClock?:string;departureTime?:string}
