...
export interface EnvironmentData{airport?:string;temperature?:number;windDirection?:number;windSpeed?:number;gust?:number;visibility?:number;runway?:string;runwayHeading?:number;runwayState?:'dry'|'wet'|'contaminated';brakingAction?:'good'|'medium'|'poor';notes?:string}
